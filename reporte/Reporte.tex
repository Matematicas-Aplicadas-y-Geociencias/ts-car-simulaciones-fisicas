...
vector del lado derecho recibe los valores $g_{*}\, h$ en las posiciones
de frontera.

Para que la solución exista físicamente, en el caso puramente Neumann debe
...
no alcanzaría el equilibrio térmico. Esta condición es la generalización
bidimensional de la relación $g_0 + g_L = 0$ obtenida en el caso 1D y se
sigue directamente del teorema de la divergencia aplicado a la ecuación de
Laplace.
